...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_array_access = 29,              /* array_access  */
  YYSYMBOL_init_list = 30,                 /* init_list  */
...
{
       0,    45,    45,    46,    50,    51,    52,    56,    63,    70,
      79,    86,    96,   105,   113,   121,   129,   140,   144,   151,
...
static const char *const yytname[] =
{
  ...
  "NUMBER", "CHAR_LITERAL", "SEMICOLON", "EQ", "PLUS", "MINUS", "MULTIPLY",
  "DIVIDE", "LBRACKET", "RBRACKET", "LBRACE", "RBRACE", "COMMA", "KEYWORD",
  "LPAREN", "RPAREN", "'('", "')'", "$accept", "program", "stmt",
  "declaration", "assignment", "print_stmt", "array_access", "init_list",
...
{
     -13,     5,   -13,    -7,     1,    -9,   -13,   -13,   -13,   -13,
       7,     8,     8,     9,     8,     8,    25,   -13,   -13,     8,
     -13,    39,    43,   -13,     8,    23,    24,    49,    15,   -13,
       8,     8,     8,     8,    50,    55,    58,    71,   -13,   -13,
      19,    19,   -13,   -13,     8,   -13,    32,   -13,    59,   -13,
      64,    75,   -13,     8,    67,    26,    65,    76,    77,     8,
     -13,   -13,    65
};
...
{
       3,     0,     1,     0,     0,     0,     2,     4,     5,     6,
       0,     0,     0,     0,     0,     0,    21,    19,    20,     0,
      22,     0,     0,     7,     0,     0,     0,     0,     0,    12,
       0,     0,     0,     0,    15,     0,     0,     0,    13,    23,
      24,    25,    26,    27,     0,     8,     0,    14,     0,    10,
...
{
     -13,   -13,   -13,   -13,   -13,   -13,    81,   -13,   -12
};

/* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
       0,     1,     6,     7,     8,     9,    20,    55,    21
};
...
{
      22,    11,    26,    27,    13,     2,    12,    28,     3,     4,
      14,    16,    35,    17,    18,    15,    23,    24,    40,    41,
      42,    43,    25,     5,    30,    31,    32,    33,    36,    19,
      32,    33,    48,    30,    31,    32,    33,    39,    12,    49,
      50,    56,    58,    59,    37,    51,    29,    62,    30,    31,
      32,    33,    30,    31,    32,    33,    38,    34,    30,    31,
      32,    33,    45,    44,    30,    31,    32,    33,    30,    31,
      32,    33,    46,    52,    30,    31,    32,    33,    47,    53,
      54,    57,    10,    60,    61
};

static const yytype_int8 yycheck[] =
{
      12,     8,    14,    15,     3,     0,    13,    19,     3,     4,
      19,     3,    24,     5,     6,     8,     7,     8,    30,    31,
      32,    33,    13,    18,     9,    10,    11,    12,     5,    21,
      11,    12,    44,     9,    10,    11,    12,    22,    13,     7,
       8,    53,    16,    17,    20,    13,     7,    59,     9,    10,
      11,    12,     9,    10,    11,    12,     7,    14,     9,    10,
      11,    12,     7,    13,     9,    10,    11,    12,     9,    10,
      11,    12,    14,    14,     9,    10,    11,    12,     7,    15,
       5,    14,     1,     7,     7
};
...
{
       0,    24,     0,     3,     4,    18,    25,    26,    27,    28,
      29,     8,    13,     3,    19,     8,     3,     5,     6,    21,
      29,    31,    31,     7,     8,    13,    31,    31,    31,     7,
       9,    10,    11,    12,    14,    31,     5,    20,     7,    22,
      31,    31,    31,    31,    13,     7,    14,     7,    31,     7,
       8,    13,    14,    15,     5,    30,    31,    14,    16,    17,
       7,     7,    31
};
...
#line 1143 "parser.tab.c"
  ...
  case 7: /* declaration: TYPE IDENTIFIER SEMICOLON  */
#line 57 "parser.y"
        { 
          (yyval.node) = createDecl((yyvsp[-1].str)); 
          char varType = (strcmp((yyvsp[-2].str), "char") == 0) ? 'c' : 'i';
...
#line 1154 "parser.tab.c"
  ...
  case 8: /* declaration: TYPE IDENTIFIER EQ expression SEMICOLON  */
#line 64 "parser.y"
        { 
          (yyval.node) = createAssign((yyvsp[-3].str), (yyvsp[-1].node));
          char varType = (strcmp((yyvsp[-4].str), "char") == 0) ? 'c' : 'i';
...
#line 1165 "parser.tab.c"
  ...
  case 9: /* declaration: TYPE IDENTIFIER LBRACKET NUMBER RBRACKET EQ LBRACE init_list RBRACE SEMICOLON  */
#line 71 "parser.y"
        { 
          int initCount;
          ...
          printf("Initialized array declaration: %s[%d] with %d values\n", (yyvsp[-8].str), (yyvsp[-6].num), initCount);
        }
#line 1178 "parser.tab.c"
    break;

  case 10: /* declaration: TYPE IDENTIFIER LBRACKET NUMBER RBRACKET SEMICOLON  */
#line 80 "parser.y"
        { 
...
#line 1189 "parser.tab.c"
  ...
  case 11: /* declaration: TYPE IDENTIFIER LBRACKET NUMBER RBRACKET LBRACKET NUMBER RBRACKET SEMICOLON  */
#line 87 "parser.y"
        { 
...
#line 1200 "parser.tab.c"
  ...
  case 12: /* assignment: IDENTIFIER EQ expression SEMICOLON  */
#line 97 "parser.y"
        { 
...
#line 1213 "parser.tab.c"
  ...
  case 13: /* assignment: array_access EQ expression SEMICOLON  */
#line 106 "parser.y"
        {
...
#line 1222 "parser.tab.c"
  ...
  case 14: /* print_stmt: KEYWORD LPAREN expression RPAREN SEMICOLON  */
#line 114 "parser.y"
        {
...
#line 1231 "parser.tab.c"
  ...
  case 15: /* array_access: IDENTIFIER LBRACKET expression RBRACKET  */
#line 122 "parser.y"
        {
          if (!isVarDeclared((yyvsp[-3].str))) {
              fprintf(stderr, "Error: variable '%s' not declared\n", (yyvsp[-3].str));
...
#line 1243 "parser.tab.c"
  ...
  case 16: /* array_access: IDENTIFIER LBRACKET expression RBRACKET LBRACKET expression RBRACKET  */
#line 130 "parser.y"
        {
...
#line 1263 "parser.tab.c"
  ...
  case 18: /* init_list: init_list COMMA expression  */
#line 145 "parser.y"
        {
...
#line 1277 "parser.tab.c"
  ...
  case 20: /* expression: CHAR_LITERAL  */
#line 152 "parser.y"
...
#line 1295 "parser.tab.c"
  ...
  case 22: /* expression: array_access  */
#line 160 "parser.y"
                         { (yyval.node) = (yyvsp[0].node); }
