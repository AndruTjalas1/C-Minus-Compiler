...
{
       0,    44,    44,    45,    49,    50,    51,    55,    62,    69,
      76,    86,    95,   103,   111,   119,   130,   131,   132,   139,
     140,   141,   142,   143,   144
};
#endif
...
static const char *const yytname[] =
{
  ...
  "DIVIDE", "LBRACKET", "RBRACKET", "COMMA", "KEYWORD", "LPAREN", "RPAREN",
  "'('", "')'", "$accept", "program", "stmt", "declaration", "assignment",
  "print_stmt", "array_access", "expression", YY_NULLPTR
};
...
{
     -13,     1,   -13,    54,    20,    36,   -13,   -13,   -13,   -13,
      25,     3,     3,    22,     3,     3,    51,   -13,   -13,     3,
     -13,    29,    33,   -13,     3,    60,    16,    39,     4,   -13,
       3,     3,     3,     3,    53,    45,    55,    61,   -13,   -13,
      -1,    -1,   -13,   -13,     3,   -13,    24,   -13,    49,   -13,
      65,   -13,    57,    66,   -13
};
...
{
       3,     0,     1,     0,     0,     0,     2,     4,     5,     6,
       0,     0,     0,     0,     0,     0,    18,    16,    17,     0,
      19,     0,     0,     7,     0,     0,     0,     0,     0,    11,
       0,     0,     0,     0,    14,     0,     0,     0,    12,    20,
      21,    22,    23,    24,     0,     8,     0,    13,     0,     9,
       0,    15,     0,     0,    10
};
...
{
      22,     2,    26,    27,     3,     4,    16,    28,    17,    18,
      32,    33,    35,    30,    31,    32,    33,     5,    40,    41,
      42,    43,    19,    13,    39,    30,    31,    32,    33,    23,
      24,    49,    48,    15,    37,    25,    29,    50,    30,    31,
      32,    33,    30,    31,    32,    33,    38,    34,    30,    31,
      32,    33,    45,    14,    30,    31,    32,    33,    30,    31,
      32,    33,    11,    51,    12,    36,    44,    12,    47,    46,
      52,    53,    10,    54
};

static const yytype_int8 yycheck[] =
{
      12,     0,    14,    15,     3,     4,     3,    19,     5,     6,
      11,    12,    24,     9,    10,    11,    12,    16,    30,    31,
      32,    33,    19,     3,    20,     9,    10,    11,    12,     7,
       8,     7,    44,     8,    18,    13,     7,    13,     9,    10,
      11,    12,     9,    10,    11,    12,     7,    14,     9,    10,
      11,    12,     7,    17,     9,    10,    11,    12,     9,    10,
      11,    12,     8,    14,    13,     5,    13,    13,     7,    14,
       5,    14,     1,     7
};
...
{
       0,    22,     0,     3,     4,    16,    23,    24,    25,    26,
      27,     8,    13,     3,    17,     8,     3,     5,     6,    19,
      27,    28,    28,     7,     8,    13,    28,    28,    28,     7,
       9,    10,    11,    12,    14,    28,     5,    18,     7,    20,
      28,    28,    28,    28,    13,     7,    14,     7,    28,     7,
      13,    14,     5,    14,     7
};
...
#line 1155 "parser.tab.c"
  ...
  case 9: /* declaration: TYPE IDENTIFIER LBRACKET NUMBER RBRACKET SEMICOLON  */
#line 70 "parser.y"
        { 
...
#line 1166 "parser.tab.c"
  ...
  case 10: /* declaration: TYPE IDENTIFIER LBRACKET NUMBER RBRACKET LBRACKET NUMBER RBRACKET SEMICOLON  */
#line 77 "parser.y"
        { 
...
#line 1177 "parser.tab.c"
  ...
  case 11: /* assignment: IDENTIFIER EQ expression SEMICOLON  */
#line 87 "parser.y"
        { 
...
#line 1190 "parser.tab.c"
  ...
  case 12: /* assignment: array_access EQ expression SEMICOLON  */
#line 96 "parser.y"
        {
...
#line 1199 "parser.tab.c"
  ...
  case 13: /* print_stmt: KEYWORD LPAREN expression RPAREN SEMICOLON  */
#line 104 "parser.y"
        {
...
#line 1208 "parser.tab.c"
  ...
  case 14: /* array_access: IDENTIFIER LBRACKET expression RBRACKET  */
#line 112 "parser.y"
        {
          if (!isVarDeclared((yyvsp[-3].str))) {
              fprintf(stderr, "Error: variable '%s' not declared\n", (yyvsp[-3].str));
...
#line 1220 "parser.tab.c"
  ...
  case 15: /* array_access: IDENTIFIER LBRACKET expression RBRACKET LBRACKET expression RBRACKET  */
#line 120 "parser.y"
        {
...
#line 1256 "parser.tab.c"
  ...
  case 19: /* expression: array_access  */
#line 139 "parser.y"
...
#line 1280 "parser.tab.c"
  ...
  case 23: /* expression: expression MULTIPLY expression  */
#line 143 "parser.y"
                                     { (yyval.node) = createBinOp('*', (yyvsp[-2].node), (yyvsp[0].node)); }
#line 1286 "parser.tab.c"
    break;

  case 24: /* expression: expression DIVIDE expression  */
#line 144 "parser.y"
                                     { (yyval.node) = createBinOp('/', (yyvsp[-2].node), (yyvsp[0].node)); }
