...
static const char *const yytname[] =
{
  ...
  "TYPE", "SEMICOLON", "EQ", "PLUS", "MINUS", "MULTIPLY", "DIVIDE",
  "LBRACKET", "RBRACKET", "COMMA", "KEYWORD", "'('", "')'", "$accept",
  "program", "declaration", "expression", YY_NULLPTR
};
...
{
      -7,    29,    -7,     5,    -7,     0,    -7,    -3,     6,    -7,
      -7,    -3,    17,     8,    -6,    -7,    -3,    -3,    -3,    -3,
      12,    -7,     9,     9,    -7,    -7,    -7,    18,    19,    24,
      -7
};
...
{
       9,    10,    16,    17,    18,    19,     6,     7,     5,    14,
      13,    21,     8,    11,    22,    23,    24,    25,    26,    18,
      19,    20,    28,    15,    27,    16,    17,    18,    19,     2,
      30,     0,    29,     0,     3
};

static const yytype_int8 yycheck[] =
{
       3,     4,     8,     9,    10,    11,     6,     7,     3,    11,
       4,    17,    12,    16,    16,    17,    18,    19,     6,    10,
      11,    13,     4,     6,    12,     8,     9,    10,    11,     0,
       6,    -1,    13,    -1,     5
};
...
{
       0,    19,     0,     5,    20,     3,     6,     7,    12,     3,
       4,    16,    21,     4,    21,     6,     8,     9,    10,    11,
      13,    17,    21,    21,    21,    21,     6,    12,     4,    13,
       6
};
